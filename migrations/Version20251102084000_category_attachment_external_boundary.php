...
final class Version20251102084000_category_attachment_external_boundary extends AbstractMigration
{
    ...
    {
        $this->addSql("ALTER TABLE category_attachment ADD provider VARCHAR(64) NOT NULL DEFAULT 'attachment'");
        $this->addSql("ALTER TABLE category_attachment ADD external_attachment_id VARCHAR(255) NOT NULL DEFAULT ''");
        $this->addSql("UPDATE category_attachment SET external_attachment_id = path WHERE external_attachment_id = ''");
        $this->addSql('DROP INDEX IF EXISTS ux_category_attachment_identity');
        $this->addSql('CREATE UNIQUE INDEX ux_category_attachment_external_binding ON category_attachment (category_id, type, provider, external_attachment_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX ux_category_attachment_identity ON category_attachment (category_id, type, path)');
