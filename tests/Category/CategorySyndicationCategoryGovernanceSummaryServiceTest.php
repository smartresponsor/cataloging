...
use App\Service\CategorySyndicationCategoryGovernanceSummaryService;
use PHPUnit\Framework\TestCase;

final class CategorySyndicationCategoryGovernanceSummaryServiceTest extends TestCase
{
    public function testBuildSummaryAggregatesTrailPayloadsAcrossDestinationsForCategory(): void
    {
        $service = new CategorySyndicationCategoryGovernanceSummaryService(new CategorySyndicationCategoryGovernanceSummaryPolicy());
