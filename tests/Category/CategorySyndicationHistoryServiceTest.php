...
use App\Service\CategorySyndicationHistoryService;
use App\ValueObject\CategorySyndicationDeliveryStatus;
use PHPUnit\Framework\TestCase;

final class CategorySyndicationHistoryServiceTest extends TestCase
{
    public function testBuildDestinationHistoryReturnsStatusBreakdown(): void
    {
        $service = new CategorySyndicationHistoryService(
