...
final class CategoryMutationServiceTest extends TestCase
{
    ...
    {
        $connection->executeStatement('CREATE TABLE catalog (id INTEGER PRIMARY KEY, object_code TEXT, object_uuid BLOB DEFAULT NULL, object_slug TEXT DEFAULT NULL, object_first_title TEXT DEFAULT NULL, object_middle_title TEXT DEFAULT NULL, object_last_title TEXT DEFAULT NULL, object_active INTEGER NOT NULL DEFAULT 1, object_enabled INTEGER NOT NULL DEFAULT 1, object_status TEXT DEFAULT NULL, object_created_at TEXT NOT NULL, object_modified_at TEXT DEFAULT NULL, object_created_by TEXT DEFAULT NULL, object_modified_by TEXT DEFAULT NULL, name TEXT NOT NULL, purpose TEXT NOT NULL, tenant TEXT NOT NULL DEFAULT "default")');
        ...
        $connection->executeStatement('CREATE TABLE category (id INTEGER PRIMARY KEY, catalog_id INTEGER NOT NULL DEFAULT 1, object_uuid BLOB DEFAULT NULL, object_slug TEXT DEFAULT NULL, object_first_title TEXT DEFAULT NULL, object_middle_title TEXT DEFAULT NULL, object_last_title TEXT DEFAULT NULL, object_created_at TEXT NOT NULL DEFAULT "2026-07-28 00:00:00", object_modified_at TEXT DEFAULT NULL, object_created_by TEXT DEFAULT NULL, object_modified_by TEXT DEFAULT NULL, object_active INTEGER NOT NULL DEFAULT 1, object_enabled INTEGER NOT NULL DEFAULT 1, object_status TEXT DEFAULT NULL, slug TEXT NOT NULL, nameEntity TEXT NOT NULL DEFAULT "", parent_id INTEGER DEFAULT NULL, depth INTEGER NOT NULL DEFAULT 0, path TEXT DEFAULT NULL, locale TEXT DEFAULT NULL, tenant TEXT DEFAULT "default", icon_url TEXT DEFAULT NULL, workflow_state TEXT NOT NULL DEFAULT "draft", published INTEGER NOT NULL DEFAULT 0, published_at TEXT DEFAULT NULL, metadata TEXT NOT NULL DEFAULT "{}")');
