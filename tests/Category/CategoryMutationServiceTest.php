...
final class CategoryMutationServiceTest extends TestCase
{
    ...
    private function createService(\Doctrine\DBAL\Connection $connection): CategoryMutationService
    {
    ...
    private function seedCategoryTree(\Doctrine\DBAL\Connection $connection): void
    {
        $rows = [
