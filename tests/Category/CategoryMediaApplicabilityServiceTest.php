...
final class CategoryMediaApplicabilityServiceTest extends TestCase
{
    public function testEvaluateReturnsChannelAndLocaleScopedCoverage(): void
    {
        ...
        $applicability = new CategoryMediaApplicabilityService($repository, new CategoryMediaApplicabilityPolicy());
