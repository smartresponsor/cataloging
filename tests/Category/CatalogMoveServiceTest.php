...
final class CatalogMoveServiceTest extends TestCase
{
    ...
    private function createConnection(): Connection
    {
        ...
        $connection->executeStatement('CREATE TABLE catalog (id INTEGER PRIMARY KEY, object_code TEXT, object_active INTEGER NOT NULL DEFAULT 1, object_enabled INTEGER NOT NULL DEFAULT 1, object_status TEXT DEFAULT NULL, object_created_at TEXT NOT NULL, object_modified_at TEXT DEFAULT NULL, object_created_by TEXT DEFAULT NULL, object_modified_by TEXT DEFAULT NULL, name TEXT NOT NULL, purpose TEXT NOT NULL, tenant TEXT NOT NULL DEFAULT "default")');
