...
final class CatalogMoveServiceTest extends TestCase
{
    ...
    private function createConnection(): Connection
    {
        ...
        $connection->executeStatement('CREATE TABLE catalog (id INTEGER PRIMARY KEY, object_uuid BLOB DEFAULT NULL, object_slug TEXT DEFAULT NULL, object_first_title TEXT DEFAULT NULL, object_middle_title TEXT DEFAULT NULL, object_last_title TEXT DEFAULT NULL, object_code TEXT, object_active INTEGER NOT NULL DEFAULT 1, object_enabled INTEGER NOT NULL DEFAULT 1, object_status TEXT DEFAULT NULL, object_created_at TEXT NOT NULL, object_modified_at TEXT DEFAULT NULL, object_created_by TEXT DEFAULT NULL, object_modified_by TEXT DEFAULT NULL, name TEXT NOT NULL, purpose TEXT NOT NULL, tenant TEXT NOT NULL DEFAULT "default")');
        $connection->executeStatement("INSERT INTO catalog (id, object_code, object_created_at, name, purpose, tenant) VALUES (1, 'test', '2026-07-28 00:00:00', 'Test', 'testing', 'default')");
        $connection->executeStatement('CREATE TABLE category (id INTEGER PRIMARY KEY, catalog_id INTEGER NOT NULL DEFAULT 1, object_uuid BLOB DEFAULT NULL, object_slug TEXT DEFAULT NULL, object_first_title TEXT DEFAULT NULL, object_middle_title TEXT DEFAULT NULL, object_last_title TEXT DEFAULT NULL, object_created_at TEXT NOT NULL DEFAULT "2026-07-28 00:00:00", object_modified_at TEXT DEFAULT NULL, object_created_by TEXT DEFAULT NULL, object_modified_by TEXT DEFAULT NULL, object_active INTEGER NOT NULL DEFAULT 1, object_enabled INTEGER NOT NULL DEFAULT 1, object_status TEXT DEFAULT NULL, nameEntity TEXT NOT NULL DEFAULT "", slug TEXT NOT NULL, parent_id INTEGER DEFAULT NULL, path TEXT NOT NULL, depth INTEGER NOT NULL, locale TEXT DEFAULT NULL, tenant TEXT NOT NULL DEFAULT "default", workflow_state TEXT NOT NULL DEFAULT "draft", published INTEGER NOT NULL DEFAULT 0, published_at TEXT DEFAULT NULL, icon_url TEXT DEFAULT NULL, metadata TEXT NOT NULL DEFAULT "{}")');
