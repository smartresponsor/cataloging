...
use App\Service\CategorySyndicationFallbackAwarePackageGateService;
use App\Service\CategorySyndicationMappingService;
use App\ValueObject\CategoryMediaRole;
use PHPUnit\Framework\TestCase;

final class CategorySyndicationFallbackAwarePackageGateServiceTest extends TestCase
{
    public function testDistinguishesStrictAndFallbackPublishability(): void
    {
        ...
        $readinessService = new CategoryDestinationMediaReadinessService(
            $destinationRepository,
            new CategoryMediaApplicabilityService($bindingRepository, new CategoryMediaApplicabilityPolicy()),
            new CategoryDestinationMediaReadinessPolicy(),
        );
        $fallbackService = new CategoryDestinationMediaFallbackService($destinationRepository, $bindingRepository, new CategoryDestinationMediaFallbackPolicy());
        $service = new CategorySyndicationFallbackAwarePackageGateService(
            $mappingService,
            $readinessService,
            $fallbackService,
