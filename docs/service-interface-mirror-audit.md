...
- `src/Service/AttachmentService.php` → expected interface `src/ServiceInterface/AttachmentServiceInterface.php`
- `src/Service/BatchImportRunner.php` → expected interface `src/ServiceInterface/BatchImportRunnerInterface.php`
- `src/Service/BillingTagEmitter.php` → expected interface `src/ServiceInterface/BillingTagEmitterInterface.php`
- `src/Service/BulkOperator.php` → expected interface `src/ServiceInterface/BulkOperatorInterface.php`
- `src/Service/CacheInvalidator.php` → expected interface `src/ServiceInterface/CacheInvalidatorInterface.php`
- `src/Service/CacheMetricsCollector.php` → expected interface `src/ServiceInterface/CacheMetricsCollectorInterface.php`
- `src/Service/CanonicalPolicyLocale.php` → expected interface `src/ServiceInterface/CanonicalPolicyLocaleInterface.php`
- `src/Service/CanonicalResolver.php` → expected interface `src/ServiceInterface/CanonicalResolverInterface.php`
...
- `src/Service/CircuitBreaker.php` → expected interface `src/ServiceInterface/CircuitBreakerInterface.php`
- `src/Service/CloudflarePurger.php` → expected interface `src/ServiceInterface/CloudflarePurgerInterface.php`
- `src/Service/CollectionBuilder.php` → expected interface `src/ServiceInterface/CollectionBuilderInterface.php`
- `src/Service/DataResidencyGuard.php` → expected interface `src/ServiceInterface/DataResidencyGuardInterface.php`
- `src/Service/DlqService.php` → expected interface `src/ServiceInterface/DlqServiceInterface.php`
- `src/Service/DraftPolicy.php` → expected interface `src/ServiceInterface/DraftPolicyInterface.php`
- `src/Service/EdgeClientCloudflare.php` → expected interface `src/ServiceInterface/EdgeClientCloudflareInterface.php`
- `src/Service/EdgeClientFastly.php` → expected interface `src/ServiceInterface/EdgeClientFastlyInterface.php`
- `src/Service/EtagGenerator.php` → expected interface `src/ServiceInterface/EtagGeneratorInterface.php`
...
- `src/Service/FacetIndexBuilder.php` → expected interface `src/ServiceInterface/FacetIndexBuilderInterface.php`
- `src/Service/FacetRank.php` → expected interface `src/ServiceInterface/FacetRankInterface.php`
- `src/Service/FacetSearch.php` → expected interface `src/ServiceInterface/FacetSearchInterface.php`
- `src/Service/FacetSearchAdvanced.php` → expected interface `src/ServiceInterface/FacetSearchAdvancedInterface.php`
