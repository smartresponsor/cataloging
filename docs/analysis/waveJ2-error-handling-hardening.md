...
- `src/Service/CatalogBatchImportRunnerService.php`
- `src/Service/CategoryBulk.php`
- `src/Service/CategoryMoveService.php`
- `src/Service/CatalogImportPipelineService.php`
...
- added `processResult()` to `CatalogImportPipelineService` so callers can move to explicit outcomes without breaking existing boolean callers
