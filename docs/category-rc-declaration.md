...
- OpenAPI contract draft in `api/category-openapi.yaml`
...
This repository is suitable to be treated as the first real release-candidate candidate of the Category component.
