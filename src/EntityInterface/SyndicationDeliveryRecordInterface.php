 ...
 */
interface CatalogSyndicationDeliveryRecordInterface
{
    /**
...
if (!class_exists(__NAMESPACE__.'\\SyndicationDeliveryRecordInterface', false)) {
    class_alias(CatalogSyndicationDeliveryRecordInterface::class, __NAMESPACE__.'\\SyndicationDeliveryRecordInterface');
}
