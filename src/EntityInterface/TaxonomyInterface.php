 ...
 */
interface CatalogTaxonomyInterface
{
    /**
...
if (!class_exists(__NAMESPACE__.'\\TaxonomyInterface', false)) {
    class_alias(CatalogTaxonomyInterface::class, __NAMESPACE__.'\\TaxonomyInterface');
}
