...
use App\ServiceInterface\Command\Category\CategoryCommandServiceInterface;
use App\ServiceInterface\Seo\Category\CategorySlugGeneratorInterface;
use Psr\EventDispatcher\EventDispatcherInterface;

/**
 * Category command service — implements create/move/attach/detach using contracts.
 * Storage specifics are delegated to the repository.
 */
final class CategoryCommandService implements CategoryCommandServiceInterface
{
    public function __construct(
        private readonly CategoryRepositoryInterface $repo,
        private readonly CategoryPolicyInterface $policy,
        private readonly CategorySlugGeneratorInterface $slugger,
