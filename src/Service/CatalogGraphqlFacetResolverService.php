...
use App\Cataloging\ServiceInterface\CatalogGraphqlFacetResolverServiceInterface;
 ...
 */
final readonly class CatalogGraphqlFacetResolverService implements CatalogGraphqlFacetResolverServiceInterface
{
    /**
     * Initializes the graphql facet resolver service collaborators.
     */
    public function __construct(private CatalogSearchService $searchService)
    {
    }
