...
final class CategorySyndicationHistoryService implements CategorySyndicationHistoryServiceInterface
{
    ...
    public function buildDestinationHistory(string $destinationId, array $records, string $actorId, string $reason): CategorySyndicationDestinationHistoryBuiltInterface
    {
        ...
        foreach ($filtered as $record) {
            ...
            if (null !== $record->deliveredAt() && (null === $latestDeliveredAt || $record->deliveredAt() > $latestDeliveredAt)) {
