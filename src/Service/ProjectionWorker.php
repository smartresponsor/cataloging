...
final class ProjectionWorker
{
    ...
    public function runOnce(int $limit = 100): int
    {
        ...
        $rows = $this->connection->fetchAllAssociative(
            ...
            .'FROM outbox '
            .'WHERE processed_at IS NULL AND dead_lettered_at IS NULL AND (available_at IS NULL OR available_at <= :now) '
    ...
    private function markFailure(string $outboxId, array $event, int $attempt, \DateTimeImmutable $now, \Throwable $exception): void
    {
