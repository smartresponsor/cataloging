...
use App\ServiceInterface\CategoryReviewDecisionCouplingServiceInterface;
use App\ServiceInterface\CategoryWorkflowTransitionServiceInterface;

final class CategoryReviewDecisionCouplingService implements CategoryReviewDecisionCouplingServiceInterface
{
    public function __construct(
        private readonly CategoryChangeRequestServiceInterface $changeRequestService,
        private readonly CategoryWorkflowTransitionServiceInterface $workflowTransitionService,
        private readonly CategoryPublicationGateServiceInterface $publicationGateService,
    ) {
    }
