...
use App\Cataloging\ServiceInterface\CatalogCategorySerializerServiceInterface;
use App\Cataloging\ValueObject\CategorySerializationRequest;

/**
 * Provides the category serializer application service.
 */
final class CatalogCategorySerializerService implements CatalogCategorySerializerServiceInterface
{
