 ...
 */
interface CatalogSyndicationDeliveryRecordedEventInterface
{
    /**
...
if (!class_exists(__NAMESPACE__.'\\SyndicationDeliveryRecordedInterface', false)) {
    class_alias(CatalogSyndicationDeliveryRecordedEventInterface::class, __NAMESPACE__.'\\SyndicationDeliveryRecordedInterface');
}
