...
interface CatalogSyndicationDestinationGovernanceSummaryBuiltEventInterface
{
...
if (!class_exists(__NAMESPACE__.'\\SyndicationDestinationGovernanceSummaryBuiltInterface', false)) {
    class_alias(CatalogSyndicationDestinationGovernanceSummaryBuiltEventInterface::class, __NAMESPACE__.'\\SyndicationDestinationGovernanceSummaryBuiltInterface');
}
