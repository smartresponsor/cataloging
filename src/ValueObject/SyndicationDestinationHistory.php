...
use App\Cataloging\ValueObjectInterface\CatalogSyndicationDestinationHistoryInterface;

/**
 * Represents the category syndication destination history value.
 */
final readonly class CatalogSyndicationDestinationHistory implements CatalogSyndicationDestinationHistoryInterface
{
    /**
...
if (!class_exists(__NAMESPACE__.'\\SyndicationDestinationHistory', false)) {
    class_alias(CatalogSyndicationDestinationHistory::class, __NAMESPACE__.'\\SyndicationDestinationHistory');
}
