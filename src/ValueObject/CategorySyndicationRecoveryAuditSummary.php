...
use App\Cataloging\ValueObjectInterface\CategorySyndicationRecoveryAuditSummaryInterface;

/**
 * Represents the category syndication recovery audit summary value.
 */
final readonly class CategorySyndicationRecoveryAuditSummary implements CategorySyndicationRecoveryAuditSummaryInterface
{
    /**
    ...
    public function __construct(
        ...
        private int $nonRetryableFailed,
        private int $scheduledRetries,
        private int $deliveredAfterRetry,
        private int $maxAttemptSeen,
        private array $affectedCategoryIds,
    ) {
    }
