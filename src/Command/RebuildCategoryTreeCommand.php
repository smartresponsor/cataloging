...
use App\Service\Command\Category\TreeConsistencyChecker;
use App\Service\Workflow\Category\ProjectionRunner;
...
final class RebuildCategoryTreeCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        file_put_contents('report/catalog-consistency.json', json_encode([
            'errors' => $errors,
            'rebuilt' => $rebuilt,
        ], JSON_PRETTY_PRINT));
