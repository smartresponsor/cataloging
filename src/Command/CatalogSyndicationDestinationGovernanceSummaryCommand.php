...
final class CatalogSyndicationDestinationGovernanceSummaryCommand extends Command
{
    ...
    {
        try {
            $event = $this->service->buildSummary(new CatalogSyndicationDestinationGovernanceSummaryRequest(
...
if (!class_exists(__NAMESPACE__.'\\SyndicationDestinationGovernanceSummaryCommand', false)) {
    class_alias(CatalogSyndicationDestinationGovernanceSummaryCommand::class, __NAMESPACE__.'\\SyndicationDestinationGovernanceSummaryCommand');
}
