...
final class CatalogSyndicationDestinationHistoryCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach (is_array($decoded) ? $decoded : [] as $row) {
            ...
            $records[] = new CatalogSyndicationDeliveryRecordEntity(
...
if (!class_exists(__NAMESPACE__.'\\SyndicationDestinationHistoryCommand', false)) {
    class_alias(CatalogSyndicationDestinationHistoryCommand::class, __NAMESPACE__.'\\SyndicationDestinationHistoryCommand');
}
