...
namespace App\Runner\Category;

use App\ProjectionInterface\Category\CategoryProjectionSyncInterface;
use App\RunnerInterface\Category\CategoryProjectionRunnerInterface;
