...
use App\Service\Import\Category\AttachmentService;
...
final class CategoryAttachmentController
{
    ...
    #[Route('/api/catalog/attachment', name: 'api_category_attachment_list', methods: ['GET'])]
    public function list(): JsonResponse
    {
        return new JsonResponse($this->service->list());
    }

    #[Route('/api/catalog/attachment', name: 'api_category_attachment_add', methods: ['POST'])]
