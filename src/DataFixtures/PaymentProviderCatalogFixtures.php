...
final class PaymentProviderCatalogFixtures extends Fixture implements FixtureGroupInterface
{
    private const PROVIDERS = [
        'internal' => ['label' => 'Internal', 'types' => []],
        'stripe' => ['label' => 'Stripe', 'types' => [
            ['code' => 'card', 'label' => 'Card'],
        ]],
        'paypal' => ['label' => 'PayPal', 'types' => [
