 ...
 */
final readonly class CatalogSyndicationDestinationHistoryBuilt implements CatalogSyndicationDestinationHistoryBuiltInterface
{
    /**
...
if (!class_exists(__NAMESPACE__.'\\SyndicationDestinationHistoryBuilt', false)) {
    class_alias(CatalogSyndicationDestinationHistoryBuilt::class, __NAMESPACE__.'\\SyndicationDestinationHistoryBuilt');
}
