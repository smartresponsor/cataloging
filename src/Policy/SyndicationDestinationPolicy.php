...
final class CatalogSyndicationDestinationPolicy implements CatalogSyndicationDestinationPolicyInterface
{
...
if (!class_exists(__NAMESPACE__.'\\SyndicationDestinationPolicy', false)) {
    class_alias(CatalogSyndicationDestinationPolicy::class, __NAMESPACE__.'\\SyndicationDestinationPolicy');
}
