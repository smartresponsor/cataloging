...
final class CategorySyndicationGovernanceSummaryAccumulator
{
    ...
    public function __construct(?ArrayValueNormalizer $arrayValueNormalizer = null)
    {
        $this->arrayValueNormalizer = $arrayValueNormalizer ?? new ArrayValueNormalizer();
    }
    ...
    public function ingest(array $payload): void
    {
        ...
        foreach ($this->arrayValueNormalizer->stringList($payload['warnings'] ?? null) as $warning) {
