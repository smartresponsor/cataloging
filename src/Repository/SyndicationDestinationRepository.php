...
if (!class_exists(__NAMESPACE__.'\\SyndicationDestinationRepository', false)) {
    class_alias(CatalogSyndicationDestinationRepository::class, __NAMESPACE__.'\\SyndicationDestinationRepository');
}
